    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-32 font-bold mt-4">Create Account</h1>
          <p className="text-text-secondary mt-2">Start scoring smarter today</p>
        </div>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  minLength={8}
                />
                <p className="text-12 text-text-secondary mt-1">At least 8 characters</p>
              </div>
        ...
        <p className="text-center text-12 text-text-secondary mt-4">
